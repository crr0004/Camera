...
public class Plane {
	...
	public Plane(Vector3f pos, Vector3f colour){
		this.pos = pos;
		this.colour = colour;
	}
	
	public void draw(NoLightingShader shader){
		
		PVM.pushMatrix();
		//PVM.rotate(45, 0, 0);
		PVM.translate(pos.x, pos.y, pos.z);
		PVM.scale(100, 100, 100);
		PVM.bufferMatricies();
		PVM.popMatrix();
	...
	public void create(){
		...
		try {
			texture = TextureLoader.getTexture("JPG", ResourceLoader.getResourceAsStream("wood_floor.jpg"));
		} catch (IOException e) {
